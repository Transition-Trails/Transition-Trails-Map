...
- Complete navigational shell (6 sidebar groups, 50+ routes)
...
- Slack integration (live — @penny bot posting confirmed)
...
> **Note:** Several items originally scoped to Phase 2 shipped in Phase 1 and are marked Complete below.
...
- **Coach and Learner views** — planned inside Trail OS, gated by Google Groups membership; not a separate product and not yet designed
