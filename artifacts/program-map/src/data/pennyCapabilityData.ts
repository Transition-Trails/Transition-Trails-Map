...
export const pennyCapabilities: PennyCapability[] = [
...

  {
    ...
    futureIntegrationStatus: 'Planned — Agentforce integration. Live Slack DM delivery. Full conversation logging to Salesforce.',
...

  {
    ...
    futureIntegrationStatus: 'Planned — Triggered by LMS completion webhook. Response stored in Salesforce engagement record.',
...

  {
    ...
    maturity: 'Defined',
    owner: 'Penny Product Lead',
    futureIntegrationStatus: 'Planned — Agentforce flows. Escalation logged to Case__c in Salesforce.',
...

  {
    ...
    futureIntegrationStatus: 'Planned — File upload to Penny via Slack attachment. Feedback delivered as structured Slack message.',
...

  {
    ...
    maturity: 'Defined',
    owner: 'Career Services Lead',
    futureIntegrationStatus: 'Planned — LinkedIn profile paste to Slack. No direct LinkedIn API access planned.',
...

  {
    ...
    maturity: 'Planned',
    owner: 'Career Services Lead',
    futureIntegrationStatus: 'Planned — Structured mock interview session in Slack thread. Feedback logged to Salesforce contact record.',
    dependencies: ['cap-learner-coaching', 'cap-knowledge-retrieval'],
...

  {
    ...
    maturity: 'Defined',
    owner: 'Penny Content Author',
    futureIntegrationStatus: 'Planned — Triggered by sprint schedule + progress data. Integrated with LMS completion data.',
...

  {
    ...
    maturity: 'Planned',
    owner: 'Penny Product Lead',
    futureIntegrationStatus: 'Planned — Automated via Agentforce scheduled flow. Delivered to coach Slack channel every Monday.',
...

  {
    ...
    maturity: 'Defined',
    owner: 'Penny Content Author',
    futureIntegrationStatus: 'Planned — On-demand via Slack command. Weekly digest triggered by calendar event.',
...

  {
    ...
    futureIntegrationStatus: 'Live — RAG pipeline active over Knowledge Library. Salesforce Knowledge__c as source of truth.',
    dependencies: [],
    pocMapping: 'RAG pipeline live over Knowledge Library. Penny answers learner and coach questions with source citations.',
    pocStatus: 'exists',
    nextSteps: [
      'Add confidence scoring (high/medium/low)',
      'Implement "I don\'t know" handling with escalation path',
      'Wire Knowledge Library standards compliance into retrieval',
      'Add update cadence monitoring for knowledge index freshness',
    ],
...

  {
    ...
    maturity: 'Defined',
    owner: 'Knowledge Lead',
    futureIntegrationStatus: 'Planned — Personalized recommendation engine. Trailhead API integration planned.',
...

  {
    ...
    maturity: 'Planned',
    owner: 'Penny Product Lead',
    futureIntegrationStatus: 'Planned — Monthly automated brief. On-demand generation via Slack command.',
    ...
    nextSteps: [
      ...
      'Pilot with Foundations Trail cohort data',
    ],
  },
...

  {
    ...
    futureIntegrationStatus: 'Planned — Slack API integration via Bolt. OAuth workspace connection.',
    dependencies: [],
...

  {
    ...
    maturity: 'Defined',
    owner: 'Communications Lead',
    futureIntegrationStatus: 'Planned — Google Chat API integration. Space membership management via Google Workspace.',
    dependencies: [],
...

  {
    ...
    maturity: 'Defined',
    owner: 'Communications Lead',
    futureIntegrationStatus: 'Planned — Google Calendar API integration. Reminder personalization from Salesforce progress data.',
...

  {
    ...
    futureIntegrationStatus: 'Planned — Quest delivery via Slack. Completion tracking in Training_Plan_Item__c.',
    dependencies: ['cap-learner-coaching', 'cap-slack-messaging'],
...

  {
    ...
    maturity: 'Defined',
    owner: 'Penny Content Author',
    futureIntegrationStatus: 'Planned — Scheduled weekly via calendar trigger. Commitment capture stored in Salesforce.',
