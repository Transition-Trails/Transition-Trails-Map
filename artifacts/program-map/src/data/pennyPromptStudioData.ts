...
GUARDRAILS: Never invent features or limits. Always cite.`,
...

  {
    ...
    guardrails: [
      ...
      'Do not make clinical or diagnostic judgments about learner behaviour',
    ],
    owner: 'Penny Product Lead',
    status: 'Review',
    version: '0.8',
...
GUARDRAILS: No invented prompts. No grading. One question at a time.`,
...

  {
    ...
    purpose: 'Generate a structured, factual escalation alert to a coach when a learner\'s behaviour patterns cross defined thresholds. Includes supporting data and recommended action. Never sent to the learner.',
    audience: ['Coaches'],
