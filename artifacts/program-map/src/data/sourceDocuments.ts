...
export const sourceDocuments: SourceDocument[] = [
  ...
  },
  {
    ...
    lastUpdated: "Jun 2025",
    programs: ["All"],
    summary: "High-level strategic overview of all Transition Trails programs, their relationships, sequencing, and organizational purpose. The go-to document for understanding the ecosystem at a glance.",
  ...
  },
  {
    ...
    summary: "Comprehensive design document for the Explorer's Trail program, including learning objectives, session structure, delivery format, and facilitator guidance specific to this entry-level cohort.",
  ...
  },
  {
    ...
    summary: "Comprehensive design document for Foundations Trail, covering technical curriculum, Salesforce module structure, professional presence training, and hybrid delivery approach.",
  ...
  },
  {
    ...
    summary: "Early-stage proposal document outlining the vision, intended audience, and strategic rationale for a Trail of Mastery advanced program. Not yet a blueprint — details are indicative, not authoritative.",
  ...
  },
  {
    ...
    summary: "Design and delivery reference for the Digital Compass nonprofit client program. Covers organizational engagement model, curriculum structure for nonprofit digital transformation, and client partnership expectations.",
  ...
  },
  {
    ...
    lastUpdated: "May 2025",
    programs: ["Guided Trail"],
    summary: "Course canvas for the RESOLVE module within Guided Trail. Defines how the R.E.S.O.L.V.E. framework is taught as a curriculum unit, including learning objectives, activities, and assessments.",
  ...
  },
  {
    ...
    summary: "Practical facilitation reference for Explorer's Trail and Foundations Trail. Covers session setup, facilitation techniques, learner engagement strategies, and troubleshooting for early-program delivery.",
