...
export const kgNodes: KGNode[] = [
  ...
  },
  {
    ...
    label: 'Evaluate',
    sublabel: 'E',
    purpose: 'Assess the recognized need against feasibility, capacity, strategic fit, and organizational readiness before committing to a solution.',
    sourceCategory: 'RESOLVE Framework',
    owner: 'Program Manager',
    confidence: 'confirmed',
    status: 'active',
  ...
  },
  {
    ...
    label: 'Solve',
    sublabel: 'S',
    purpose: 'Design and document the solution — curriculum structure, delivery model, sprint cadence, and success criteria — based on evaluated needs.',
    sourceCategory: 'RESOLVE Framework',
    owner: 'Program Manager',
    confidence: 'confirmed',
    status: 'active',
  ...
  },
  {
    ...
    label: 'Organize',
    sublabel: 'O',
    purpose: 'Plan and prepare delivery — cohort assignments, sprint planning, facilitator scheduling, and resource coordination before the cohort begins.',
    sourceCategory: 'RESOLVE Framework',
    owner: 'Program Manager',
    confidence: 'confirmed',
    status: 'active',
  ...
  },
  {
    ...
    label: 'Leverage',
    sublabel: 'L',
    purpose: 'Execute delivery, activate coaching, and surface learner insights — the live program phase where Penny, coaches, and Trail OS are most active.',
    sourceCategory: 'RESOLVE Framework',
    owner: 'Coach Lead',
    confidence: 'confirmed',
    status: 'active',
  ...
  },
  {
    ...
    label: 'Verify',
    sublabel: 'V',
    purpose: 'Measure outcomes, validate completion, and assess program effectiveness against the success criteria defined in Solve.',
    sourceCategory: 'RESOLVE Framework',
    owner: 'Operations Lead',
    confidence: 'confirmed',
    status: 'active',
  ...
  },
  {
    ...
    label: 'Execute',
    sublabel: 'E',
    purpose: 'Transition verified learner outcomes into sustained momentum — placement support, alumni activation, and next-program progression.',
    sourceCategory: 'RESOLVE Framework',
    owner: 'Operations Lead',
    confidence: 'prototype',
    status: 'planned',
    futureIntegrations: ['Salesforce Opportunity (placement)', 'Alumni tracking'],
  },
  {
    id: 'resolve-evolve',
    type: 'resolvePhase',
    label: 'Evolve',
    sublabel: 'E',
    purpose: 'Iterate on program design, Penny capabilities, and Trail OS configuration based on outcomes data, learner feedback, and strategic shifts.',
    sourceCategory: 'RESOLVE Framework',
    owner: 'Operations Lead',
    confidence: 'prototype',
    status: 'planned',
...
export const kgEdges: KGEdge[] = [
  ...
  { id: 'e09', from: 'guided-trail',    to: 'resolve-solve',     relationship: 'applies',      confidence: 'confirmed' },
  { id: 'e10', from: 'guided-trail',    to: 'resolve-organize',  relationship: 'applies',      confidence: 'confirmed' },
  { id: 'e11', from: 'guided-trail',    to: 'resolve-leverage',  relationship: 'applies',      confidence: 'confirmed' },
  ...
  { id: 'e14', from: 'digital-compass', to: 'resolve-evaluate',  relationship: 'applies',      confidence: 'confirmed' },
  { id: 'e15', from: 'digital-compass', to: 'resolve-organize',  relationship: 'applies',      confidence: 'confirmed' },
  { id: 'e16', from: 'explorers-trail', to: 'resolve-recognize', relationship: 'applies',      confidence: 'confirmed' },
  { id: 'e17', from: 'explorers-trail', to: 'resolve-evaluate',  relationship: 'applies',      confidence: 'confirmed' },
  { id: 'e18', from: 'foundations-trail',to: 'resolve-solve',    relationship: 'applies',      confidence: 'confirmed' },
  { id: 'e19', from: 'foundations-trail',to: 'resolve-verify',   relationship: 'applies',      confidence: 'confirmed' },

  // Role → RESOLVE Phase
  { id: 'e20', from: 'role-learner',      to: 'resolve-organize',  relationship: 'engages in',  confidence: 'confirmed' },
  { id: 'e21', from: 'role-learner',      to: 'resolve-leverage',  relationship: 'engages in',  confidence: 'confirmed' },
  { id: 'e22', from: 'role-coach',        to: 'resolve-verify',    relationship: 'facilitates', confidence: 'confirmed' },
  { id: 'e23', from: 'role-coach',        to: 'resolve-leverage',  relationship: 'supports',    confidence: 'confirmed' },
  { id: 'e24', from: 'role-program-lead', to: 'resolve-recognize', relationship: 'leads',       confidence: 'confirmed' },
  { id: 'e25', from: 'role-program-lead', to: 'resolve-evaluate',  relationship: 'leads',       confidence: 'confirmed' },
  { id: 'e26', from: 'role-ops-lead',     to: 'resolve-organize',  relationship: 'manages',     confidence: 'confirmed' },
  ...
  { id: 'e30', from: 'resolve-evaluate',  to: 'cap-demand',    relationship: 'informs',        confidence: 'confirmed' },
  { id: 'e31', from: 'resolve-solve',     to: 'cap-docs',      relationship: 'produces',       confidence: 'confirmed' },
  { id: 'e32', from: 'resolve-organize',  to: 'cap-delivery',  relationship: 'requires',       confidence: 'confirmed' },
  { id: 'e33', from: 'resolve-leverage',  to: 'cap-matching',  relationship: 'activates',      confidence: 'confirmed' },
  { id: 'e34', from: 'resolve-leverage',  to: 'cap-visibility',relationship: 'requires',       confidence: 'confirmed' },
...
export const kgPaths: KGPath[] = [
  {
    ...
    nodeIds: ['guided-trail', 'role-learner', 'resolve-organize', 'cap-delivery', 'ch-cohort', 'penny-quest-master', 'kt-workplace'],
