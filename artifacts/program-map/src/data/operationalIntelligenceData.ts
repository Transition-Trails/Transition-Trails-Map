...
export const domainHealthData: DomainHealth[] = [
  {
    ...
    score: 72,
    level: 'good',
    summary: 'Five active programs with solid baseline structure. Foundations Trail and Guided Trail have the most complete health profiles; Explorer\'s Trail, Mastery, and Digital Compass have gaps in Penny coverage and role definitions.',
    indicators: [
      ...
      { id: 'prog-4', domain: 'Programs', label: 'Penny capability coverage',    status: 'needs-work',   detail: 'Digital Compass has no Penny quests or coaching prompts configured.', sourceSystem: 'Penny Capability Registry' },
  ...
  },
  {
    ...
    score: 70,
    level: 'good',
    summary: 'Core communication channels are mapped for active roles. Slack integration is in use. Google Chat mappings are defined but not live. Calendar events are structured. Key gaps: future Slack adapter not yet built, NP Partner and Client Sponsor comms undefined.',
    indicators: [
...
export const readinessScorecards: ReadinessScorecard[] = [
  ...
  },
  {
    ...
    score: 63,
    level: 'needs-work',
    summary: 'Salesforce NPSP is active and capturing core program data. Nonprofit Cloud migration is the critical path item for data readiness.',
    dimensions: [
      { label: 'CRM coverage',            score: 75, level: 'good',       notes: 'Core learner, coach, and program records in Salesforce.' },
      { label: 'Data model completeness',  score: 60, level: 'needs-work', notes: 'External partner objects (Client Sponsor, Employer Partner) undefined.' },
      { label: 'Integration data flows',   score: 50, level: 'needs-work', notes: 'Google Drive, LMS, and Slack data flows not live.' },
      { label: 'Nonprofit Cloud readiness', score: 45, level: 'at-risk',  notes: 'Migration from NPSP to Nonprofit Cloud not yet planned in detail.' },
...
export const trendInsights: TrendInsight[] = [
  ...
  },
  {
    ...
    type: 'risk',
    urgency: 'immediate',
    title: 'Nonprofit Cloud Migration Unplanned',
    description: 'The organisation is still on Salesforce NPSP. The Nonprofit Cloud migration has no detailed plan or timeline. Several integration designs assume Nonprofit Cloud object models that don\'t yet exist.',
  ...
  },
  {
    ...
    type: 'gap',
    urgency: 'near-term',
    title: 'Digital Compass Lacks Penny Coverage',
    description: 'Digital Compass has no Penny quests, coaching prompts, or capability mappings. As the community-access program with highest volunteer reliance, it most needs AI support but has none configured.',
    affectedDomains: ['Programs', 'Penny AI'],
    affectedPrograms: ['Digital Compass'],
    relatedSystems: ['Penny Capability Registry', 'Curriculum Studio'],
    actionPath: '/curriculum/standards',
  },
  {
    id: 'trend-4',
    type: 'gap',
...
export const recommendations: Recommendation[] = [
  ...
  {
    id: 'rec-2',
    action: 'Plan Nonprofit Cloud Migration Sprint',
    domain: 'Integrations',
    priority: 'critical',
    effort: 'High',
    systems: ['Integration Readiness Center', 'Salesforce Architecture Mapping'],
    nextSteps: ['Engage Salesforce partner for migration scoping', 'Audit current NPSP objects against NC equivalents', 'Create migration risk register', 'Set target go-live date'],
    status: 'open',
  },
  {
    id: 'rec-3',
  ...
  {
    id: 'rec-5',
    action: 'Configure Digital Compass Penny Coverage',
    domain: 'Programs',
    priority: 'high',
    effort: 'Medium',
    systems: ['Penny Capability Registry', 'Penny Prompt Studio', 'Curriculum Studio'],
    nextSteps: ['Author Penny quests for Digital Compass modules', 'Create coaching prompt templates', 'Map Penny capabilities to Digital Compass program', 'Test with volunteer coach cohort'],
    status: 'open',
  },
  {
    id: 'rec-6',
