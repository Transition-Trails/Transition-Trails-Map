...
export const domainHealthData: DomainHealth[] = [
  {
    ...
    indicators: [
      ...
      { id: 'prog-6', domain: 'Programs', label: 'Role ownership',              status: 'needs-work',   detail: 'Alumni Learner, Volunteer Mentor, and Employer Partner roles lack owners.', sourceSystem: 'People & Roles Studio',        actionPath: '/admin/people-access#owners',  actionLabel: 'Assign Role Owners' },
