...
export const knowledgeSources: KnowledgeSource[] = [
...

  {
    ...
    approvedForPenny: false,
    pennyUseDescription: 'Not currently connected. When connected, Penny will use this for program-specific coaching context and to supplement LMS content with coach-facing materials.',
    healthStatus: 'Critical',
    healthIssues: ['Google Drive API not connected — folder content is not accessible to Trail OS', 'Not approved for Penny until Drive connection is established and content reviewed', 'Folder structure not yet mapped to curriculum module schema'],
    futureIntegrationPath: 'Q3 2025 — Google Drive API. Folder indexing → RAG pipeline. Content must pass Standards Studio review before Penny access.',
    integrationPriority: 'P1',
...

  {
    ...
    availability: 'Partial',
    approvedForPenny: false,
    pennyUseDescription: 'Not yet connected. Future use mirrors Foundations Trail Drive integration.',
    healthStatus: 'Critical',
    healthIssues: ['Google Drive API not connected', 'Folder content not indexed or accessible to Trail OS'],
    futureIntegrationPath: 'Q3 2025 — Same pipeline as Foundations Trail Drive. Lower priority than Foundations.',
    integrationPriority: 'P2',
