      ...
      <div className="px-6 py-8 max-w-3xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Your daily workspace — Mission Control is one click away in the left drawer.
          </p>
        </div>
        ...
        <a
          href="/program"
          className="flex items-center gap-4 p-5 rounded-xl border border-primary/20 bg-primary/5 hover:bg-primary/10 transition-colors group"
        >
          <div className="w-11 h-11 rounded-lg bg-primary flex items-center justify-center flex-shrink-0 shadow-sm group-hover:shadow-md transition-shadow">
            <LayoutDashboard className="w-5 h-5 text-primary-foreground" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-foreground">Mission Control</p>
            <p className="text-xs text-muted-foreground mt-0.5">
              Open the full Trail OS admin app
            </p>
          </div>
