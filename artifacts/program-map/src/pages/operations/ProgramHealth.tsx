              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-muted/50 border-b border-border">
                    <th className="text-left px-4 py-2.5 text-[14px] font-semibold text-muted-foreground ">Program</th>
                    <th className="text-left px-4 py-2.5 text-[14px] font-semibold text-muted-foreground ">Status</th>
                    <th className="text-left px-4 py-2.5 text-[14px] font-semibold text-muted-foreground ">Enrollment</th>
                    <th className="text-left px-4 py-2.5 text-[14px] font-semibold text-muted-foreground ">Cohort</th>
                    <th className="text-left px-4 py-2.5 text-[14px] font-semibold text-muted-foreground ">Notes</th>
                    <th className="text-left px-4 py-2.5 text-[14px] font-semibold text-muted-foreground ">Next Cohort</th>
                  </tr>
                </thead>
                    ...
                    <tr key={p.name} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-muted-foreground text-[14px]">{p.status}</span>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3 text-muted-foreground text-[14px]">{p.weeks}</td>
              ...
              <div className="space-y-2">
                {alerts.map(a => (
                  <div key={a.prog} className="flex gap-3 p-3 rounded-lg bg-[#FFF3E0] border border-[#FFD08A]">
                    <Badge variant="outline" className="bg-[#FFF3E0] text-[#CC8400] border-[#FFD08A] flex-shrink-0 text-[14px] self-start mt-0.5">
                      {a.prog}
                    </Badge>
