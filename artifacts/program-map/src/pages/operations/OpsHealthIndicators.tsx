              ...
              <div key={d.id} className="rounded-lg border border-border bg-white overflow-hidden flex flex-col">
                ...
                {firstBad && (
                  <div className="px-3 py-1.5 border-t border-border/40 bg-[#FFF3E0]/50">
                    <p className="text-[14px] font-bold  text-[#CC8400]/70 mb-0.5">Next action</p>
                    <p className="text-[14px] text-muted-foreground leading-snug line-clamp-2">{firstBad.detail}</p>
                  </div>
                )}
              </div>
            );
