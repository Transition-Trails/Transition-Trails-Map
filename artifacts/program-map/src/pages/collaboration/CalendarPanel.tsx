      ...
      <div className="p-3 space-y-2">
        ...
        <div className="pt-1">
          {!prep.reply && !prep.loading && !prep.error && (
            ...
            >
              <Brain className="w-3 h-3" /> Get Penny prep brief
            </Button>
          )}
          ...
          {prep.loading && (
            <div className="flex items-center gap-2 text-[11px] text-muted-foreground">
              ...
              <span>Penny is preparing your brief…</span>
            </div>
          )}
          ...
          {prep.reply && (
            <div className="rounded-lg border border-primary/20 bg-primary/5 p-2.5 space-y-1">
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <span className="text-[10px] font-bold uppercase tracking-wider text-primary">Penny Prep Brief</span>
              </div>
      ...
      <div className="p-4 max-w-2xl space-y-4">
        ...
        {!loading && !error && events.length > 0 && (
          <p className="text-[10px] text-muted-foreground/60 text-center pt-2">
            ...
            Penny prep briefs are generated by Gemini 2.5 Flash.
          </p>
        )}
