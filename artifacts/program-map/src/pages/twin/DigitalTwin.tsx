...
const STATUS_CONFIG: Record<SelectedObject['status'], { label: string; cls: string; dot: string }> = {
  active:      { label: 'Active',      cls: 'bg-[#E6F0EA] text-[#2F6B3F] border-[#9FC3AE]', dot: 'bg-[#E6F0EA]0' },
  'in-progress':{ label: 'In Progress', cls: 'bg-[#FFF3E0] text-[#CC8400] border-[#FFD08A]',       dot: 'bg-[#CC8400]'  },
  review:      { label: 'Under Review', cls: 'bg-[#EDF5F8] text-[#2F6F7E] border-[#7FAFC6]',             dot: 'bg-[#EDF5F8]0'    },
  planned:     { label: 'Planned',      cls: 'bg-muted text-muted-foreground border-border',       dot: 'bg-[#C8CBC6]'  },
};

const SEV_CONFIG = {
  high:   { cls: 'bg-[#FBEAE6] text-[#A93F2F] border-[#E8B9B4]',    dot: 'bg-[#FBEAE6]0'   },
  ...
  capability: {
    ...
    connections: [
      { system: 'Knowledge',      label: '6 sources',   count: 6,  color: '#6d28d9', href: '/knowledge',        detail: 'Resume frameworks, feedback guides, program content',
        items: [{ id:'k1', label:'Program Framework', statusColor:'bg-[#2F6F7E]' }, { id:'k2', label:'Resume Templates', statusColor:'bg-[#2F6F7E]' }, { id:'k3', label:'Feedback Guides', statusColor:'bg-[#2F6F7E]' }, { id:'k4', label:'+3 more', statusColor:'bg-[#C8CBC6]' }] },
      { system: 'Prompt Studio',  label: '10 prompts',  count: 10, color: '#7c3aed', href: '/penny/prompts',    detail: 'Governed templates for this capability',
        items: [{ id:'ps1', label:'Reflection Prompt', statusColor:'bg-[#2F6F7E]' }, { id:'ps2', label:'Feedback Prompt', statusColor:'bg-[#2F6F7E]' }, { id:'ps3', label:'Quest Prompt', statusColor:'bg-[#2F6F7E]' }, { id:'ps4', label:'+7 more', statusColor:'bg-[#C8CBC6]' }] },
      ...
      { system: 'Curriculum',     label: '4 modules',   count: 4,  color: '#b45309', href: '/program/curriculum', detail: 'Reflection, assessment, and quest modules',
        items: [{ id:'cu1', label:'Reflection Module', statusColor:'bg-[#CC8400]' }, { id:'cu2', label:'Assessment Module', statusColor:'bg-[#CC8400]' }, { id:'cu3', label:'Quest Module', statusColor:'bg-[#CC8400]' }] },
      { system: 'Coaches',        label: '3 coaches',   count: 3,  color: '#1d4ed8', href: '/digital-twin',     detail: 'Coach brief and escalation recipients for this capability',
        items: [{ id:'co1', label:'3 coach recipients', statusColor:'bg-[#2F6F7E]' }] },
      { system: 'Salesforce',     label: 'Variables',   count: 3,  color: '#0369a1', href: '/admin/salesforce-arch', detail: 'Contact, Assessment__c, Program_Engagement__c',
        items: [{ id:'sf1', label:'Contact', statusColor:'bg-[#2F6F7E]' }, { id:'sf2', label:'Assessment__c', statusColor:'bg-[#2F6F7E]' }, { id:'sf3', label:'Program_Engagement__c', statusColor:'bg-[#2F6F7E]' }] },
    ],
  },
  course: {
    ...
    connections: [
      ...
      { system: 'Knowledge',     label: '5 articles',      count: 5, color: '#6d28d9', href: '/knowledge',              detail: 'Agile guides, sprint retrospective frameworks, learning science',
        items: [{ id:'k1', label:'Agile Guide', statusColor:'bg-[#2F6F7E]' }, { id:'k2', label:'Sprint Framework', statusColor:'bg-[#2F6F7E]' }, { id:'k3', label:'Learning Science', statusColor:'bg-[#2F6F7E]' }, { id:'k4', label:'+2 more', statusColor:'bg-[#C8CBC6]' }] },
      { system: TERMS.aiAssistant, label: '6 prompts',       count: 6, color: '#be185d', href: '/penny/prompts',          detail: 'Reflection, quest, and assessment-linked prompts',
        items: [{ id:'p1', label:'Reflection Prompt', statusColor:'bg-[#2F6F7E]' }, { id:'p2', label:'Quest Hook', statusColor:'bg-[#2F6F7E]' }, { id:'p3', label:'Assessment Feedback', statusColor:'bg-[#2F6F7E]' }, { id:'p4', label:'+3 more', statusColor:'bg-[#C8CBC6]' }] },
      { system: 'Assessments',   label: '2 assessments',   count: 2, color: '#0f766e', href: '/program',                detail: 'Pre-course and post-course assessments',
        items: [{ id:'a1', label:'Pre-course', statusColor:'bg-[#2F6B3F]' }, { id:'a2', label:'Post-course', statusColor:'bg-[#2F6B3F]' }] },
      { system: 'Coaches',       label: '4 coaches',       count: 4, color: '#1d4ed8', href: '/digital-twin',           detail: 'Facilitate this course across cohorts',
        items: [{ id:'co1', label:'4 facilitating coaches', statusColor:'bg-[#2F6F7E]' }] },
      { system: 'Salesforce',    label: 'Progress records', count: 1, color: '#0369a1', href: '/admin/salesforce-arch',   detail: 'Learner completion and progress data records',
        items: [{ id:'sf1', label:'Completion records', statusColor:'bg-[#2F6F7E]' }, { id:'sf2', label:'Progress sync', statusColor:'bg-[#2F6F7E]' }] },
    ],
  },
  role: {
    ...
    connections: [
      { system: 'Programs',      label: '3 programs',     count: 3, color: '#059669', href: '/program',           detail: 'Active program participation assignments',
        items: [{ id:'p1', label:'Guided Trail', statusColor:'bg-[#2F6B3F]' }, { id:'p2', label:"Explorer's Trail", statusColor:'bg-[#2F6B3F]' }, { id:'p3', label:'Trail of Mastery', statusColor:'bg-[#CC8400]' }] },
      { system: 'Learners',      label: '12 learners',    count: 12, color: '#059669', href: '/penny/learners',   detail: 'Currently assigned active learners',
        items: [{ id:'l1', label:'12 active learners', statusColor:'bg-[#2F6B3F]' }] },
      { system: TERMS.aiAssistant, label: 'Coach support',  count: 2, color: '#be185d', href: '/penny',             detail: 'Coach Brief generator, escalation alert logic',
        items: [{ id:'ai1', label:'Coach Brief', statusColor:'bg-[#2F6F7E]' }, { id:'ai2', label:'Escalation Alerts', statusColor:'bg-[#2F6F7E]' }] },
      { system: 'Slack Channels', label: '4 channels',   count: 4, color: '#c2410c', href: '/collaboration',      detail: '#coaches, #guided-trail, #penny-ai, #ops',
        items: [{ id:'sl1', label:'#coaches', statusColor:'bg-[#CC8400]' }, { id:'sl2', label:'#guided-trail', statusColor:'bg-[#CC8400]' }, { id:'sl3', label:'#penny-ai', statusColor:'bg-[#CC8400]' }, { id:'sl4', label:'#ops', statusColor:'bg-[#CC8400]' }] },
      { system: 'Salesforce',    label: 'User + Contact', count: 2, color: '#0369a1', href: '/admin/salesforce-arch', detail: 'Salesforce user, contact record, permission set',
        items: [{ id:'sf1', label:'User record', statusColor:'bg-[#2F6F7E]' }, { id:'sf2', label:'Contact record', statusColor:'bg-[#2F6F7E]' }] },
  ...
  knowledge: {
    ...
    connections: [
      ...
      { system: 'Programs',      label: '5 programs',     count: 5, color: '#059669', href: '/program',               detail: 'All active programs reference this source',
        items: [{ id:'pr1', label:'All 5 programs', statusColor:'bg-[#2F6B3F]' }] },
      ...
      <ScrollArea className="flex-1">
        <div className="p-5 max-w-3xl space-y-4">
          ...
          {wsTab === 'health' && (
            <div className="space-y-3">
              {[
                { label: 'Data completeness', pct: 85, color: 'bg-[#E6F0EA]0', note: 'Core fields populated across all connected systems' },
                { label: 'Salesforce sync',    pct: 100, color: 'bg-[#E6F0EA]0', note: 'Last synced less than 1 hour ago' },
                { label: 'Knowledge freshness', pct: 72, color: 'bg-[#CC8400]',  note: '2 of 8 sources flagged for review — last audit Q1 2025' },
                { label: `${TERMS.aiAssistant} coverage`,  pct: obj.kind === 'capability' ? 95 : 60, color: obj.kind === 'capability' ? 'bg-[#E6F0EA]0' : 'bg-[#CC8400]', note: 'Capabilities configured for this object' },
