...
function OverviewTab() {
  ...
  const WORKSPACES = [
    ...
    { id:'people',     name:'People & Roles',       link:'/admin/people',   filtered: !!activeContext },
...
function ImpactTab() {
  ...
  const impacts = [
    ...
    { workspace:'People & Roles',       filter:`Roles and personas associated with "${activeContext.name}"`,        active:true,  link:'/admin/people'  },
