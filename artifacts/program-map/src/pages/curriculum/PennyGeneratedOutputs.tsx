      ...
      <div className="p-6 max-w-5xl space-y-5">
        ...
        <div className="rounded-xl border-2 border-primary/20 bg-primary/5 p-4">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-[14px] font-bold text-primary border border-primary/20 bg-white rounded-full px-2 py-0.5">★ Standards Reference</span>
            <span className="text-[14px] text-muted-foreground">{output.generatedAt}</span>
          </div>
          <p className="text-[15px] font-bold text-foreground mb-1">{output.moduleName}</p>
          <p className="text-[14px] text-muted-foreground mb-3">{output.program} · {output.sprint}</p>
            ...
            {output.generatedBy.map(actionId => {
              ...
              return action ? (
                <button
                  ...
                  className="text-[14px] font-medium border border-secondary/20 bg-secondary/10 text-secondary rounded-full px-2 py-0.5 hover:bg-secondary/20 transition-colors"
                >
                  {action.shortName} →
                </button>
              ) : null;
        ...
        <div className="flex flex-wrap gap-1.5">
          {SECTION_TABS.map(tab => (
            <button
              ...
              className={`text-[14px] font-semibold rounded-full px-3 py-1.5 border transition-colors ${activeSection === tab.id ? 'bg-secondary text-white border-secondary' : 'border-border text-muted-foreground hover:border-secondary/40'}`}
            >
              {tab.icon} {tab.label}
            </button>
          ))}
