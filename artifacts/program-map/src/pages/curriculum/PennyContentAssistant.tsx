      ...
      <div className="p-6 max-w-6xl space-y-6">
        ...
        <div className="rounded-lg border border-secondary/20 bg-secondary/5 px-5 py-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-[14px] font-bold text-foreground">How Penny Content Assistant works</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {[
              ...
              <div key={item.step} className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-secondary text-white text-[14px] font-bold flex items-center justify-center shrink-0">{item.step}</span>
                <div>
