...
const PRODUCT_READINESS: ProductReadiness[] = [
  {
    ...
    overallStatus: 'pending', score: 20, objectsMapped: 3, objectsTotal: 4,
    checks: [
  ...
  },
  {
    ...
    overallStatus: 'partial', score: 40, objectsMapped: 5, objectsTotal: 6,
    checks: [
  ...
  },
  {
    ...
    overallStatus: 'blocked', score: 10, objectsMapped: 1, objectsTotal: 2,
    checks: [
  ...
  },
  {
    ...
    overallStatus: 'pending', score: 15, objectsMapped: 1, objectsTotal: 2,
    checks: [
  ...
  },
  {
    ...
    overallStatus: 'pending', score: 15, objectsMapped: 1, objectsTotal: 3,
    checks: [
  ...
  },
  {
    ...
    overallStatus: 'pending', score: 10, objectsMapped: 2, objectsTotal: 3,
    checks: [
...
const VALIDATION_WORKFLOWS: ValidationWorkflow[] = [
  {
    stage: 'Stage 1 — Object Identification',
    steps: [
      { id: 'v1', label: 'Inventory all Trail OS objects that need Salesforce backing',           status: 'validated', owner: 'Platform Lead',       detail: 'UOM defines 7 object types; 16 SF mappings identified.' },
  ...
  {
    stage: 'Stage 2 — Field-Level Mapping',
    steps: [
  ...
  {
    stage: 'Stage 3 — Data Architecture Validation',
    steps: [
  ...
  {
    stage: 'Stage 4 — Integration Testing',
    steps: [
    ...
    <div className="p-6 space-y-4 max-w-4xl">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {PRODUCT_READINESS.map(prod => {
          ...
          const open = openProduct === prod.product;
          return (
              ...
              return (
                <>
                  <tr
                    ...
                    className={`bg-background hover:bg-muted/10 transition-colors cursor-pointer ${isExpanded ? 'bg-muted/10' : ''}`}
                  >
                    ...
                    <td className="px-3 py-2.5 text-center">
                      ...
                      <div className="h-1 bg-muted rounded-full mt-0.5 w-12 mx-auto">
    ...
    <div className="p-6 space-y-4 max-w-4xl">
      ...
      <div className="rounded-lg border border-primary/20 bg-primary/5 p-4">
        ...
        {[
          ...
          { priority: 4, action: `Design ${TERMS.aiAssistant} custom object schema before requesting custom object creation` },
