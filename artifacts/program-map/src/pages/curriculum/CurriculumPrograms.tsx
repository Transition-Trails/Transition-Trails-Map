  ...
  return (
    <ScrollArea className="h-full">
      <div className="p-6 max-w-5xl space-y-6">
                ...
                return (
                  <div key={course.Id} className="rounded-xl border border-[#9FC3AE]/70 bg-white p-5 shadow-sm">
                    <div className="flex items-start justify-between gap-3 mb-3">
                      ...
                      <span className={`text-[10px] font-semibold border rounded-full px-2 py-0.5 shrink-0 ${statusCfg.cls}`}>{statusCfg.label}</span>
                    </div>
        ...
        <section>
          <div className="flex items-center gap-2 mb-3">
            <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/60">Program Architecture</p>
            <div className="flex-1 h-px bg-border/50" />
          </div>
