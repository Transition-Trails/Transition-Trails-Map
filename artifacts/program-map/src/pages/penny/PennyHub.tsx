...
export default function PennyHub() {
  ...
  const HUB_ACTIONS: ActionItem[] = [
    { id: 'new-prompt', label: 'New Prompt Template', icon: Plus, variant: 'primary', onClick: () => openActionPanel({
    ...
    { id: 'new-capability', label: 'New Capability', icon: Brain, variant: 'secondary', onClick: () => openActionPanel({
