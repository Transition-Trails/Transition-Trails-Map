...
const CONNECTIONS: IntegrationConnection[] = [
  ...
  // ── External connections ───────────────────────────────────────────────────
  {
    ...
    to: 'Slack',
    toIcon: Hash,
    description: 'Penny broadcasts weekly briefs, learner nudges, cohort health alerts, and coach notifications via Slack channels.',
    status: 'blocked',
    phase: 1,
    readiness: 25,
    method: 'Slack Bot API — messages to #cohort-channels, DMs to learners/coaches',
    blockers: ['Slack app not yet created', 'Slack bot token not yet obtained', 'Channel mapping not yet configured'],
    capabilities: ['Weekly Brief', 'Learning Coach', 'Cohort Health'],
    nextStep: 'Create Slack app in Transition Trails workspace and retrieve bot token',
  },
  {
    ...
    blockers: ['Google OAuth not yet configured', 'Drive folder structure not yet organised per program'],
    capabilities: ['Learning Coach', 'Trail Quest Runner', 'Weekly Brief'],
    nextStep: 'Complete Google OAuth setup (OAuth client ID + Drive API scope)',
  },
  {
    ...
    blockers: ['Google OAuth not yet configured', 'Shared calendar structure not yet created'],
    capabilities: ['Weekly Brief', 'Learning Coach', 'Trail Quest Runner'],
    nextStep: 'Configure Google OAuth (same flow as Drive — share scope)',
  },
  {
    id: 'penny-salesforce',
    from: 'Penny',
