...
const AREAS: ReadinessArea[] = [
  ...
  },
  {
    ...
    nextActions: [
      ...
      'Configure Gmail OAuth scope (gmail.readonly + gmail.compose) for Email Action Panel (Phase 2)',
    ],
  },
  {
    id: 'governance',
...
const OVERALL: ReadinessArea = {
  ...
  completed: [
    ...
    'Google OAuth fully live — GOOGLE_DRIVE_REFRESH_TOKEN + GOOGLE_CALENDAR_REFRESH_TOKEN obtained (Jun 13 2026)',
    'Google Drive + Google Calendar promoted to Live integrations — Admin Setup updated',
