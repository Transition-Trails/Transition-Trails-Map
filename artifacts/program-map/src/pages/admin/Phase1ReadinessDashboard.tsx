...
const AREAS: ReadinessArea[] = [
  ...
  },
  {
    ...
    completed: [
      ...
      'POST /api/penny/ask endpoint live — Trail OS context-aware AI responses returning',
    ...
    gaps: [
      ...
      '5 of 7 capabilities not yet wired to live data sources',
    ...
    nextActions: [
      'Wire Salesforce query to first Penny capability (Learning Coach or Resume Review)',
...
const OVERALL: ReadinessArea = {
  ...
  completed: [
    ...
    'Penny live — Ask Penny → Gemini 2.5 Flash · POST /api/penny/ask · billing active',
  ],
  gaps: [
  ...
  nextActions: [
    ...
    'Wire Slack integration for Penny Weekly Brief capability',
