...
const AREAS: ReadinessArea[] = [
  ...
  },
  {
    ...
    status: 'on-track',
    owner: 'Tech Lead',
    description: 'Salesforce API, Google Workspace, Slack, Agentforce, and Penny live connections.',
    completed: [
...
const OVERALL: ReadinessArea = {
  ...
  nextActions: [
    'Wire Salesforce data query to health dashboard (REST API live at /api/salesforce/validate)',
    'Wire Slack integration for Penny Weekly Brief capability using confirmed SLACK_BOT_TOKEN',
