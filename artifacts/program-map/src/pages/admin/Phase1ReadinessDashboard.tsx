...
const AREAS: ReadinessArea[] = [
  ...
  },
  {
    ...
    gaps: [
      ...
      'Penny not yet wired to GEMINI_API_KEY — first live capability call pending',
    ],
    blockers: [
      'Google OAuth refresh tokens — run /admin/google-oauth flow to unblock Drive and Calendar sources',
    ],
    nextActions: [
      'Wire first Penny capability call to GEMINI_API_KEY — Ask Penny → Gemini 2.5 Flash response',
...
const OVERALL: ReadinessArea = {
  ...
  gaps: [
    ...
    'Penny not yet wired to live Gemini endpoint — key is live, capability call pending',
  ],
  blockers: [
  ...
  nextActions: [
    ...
    'Wire first Penny capability to live GEMINI_API_KEY — Gemini 2.5 Flash confirmed available',
