...
const CARDS: BacklogCard[] = [
  ...
  },
  {
    ...
    phase: 'Phase 2',
    owner: 'Tech Lead',
    summary: 'Org-level signal routing rules shipped via Collaboration Overview (/collaboration) — channel rule config (Slack, Gmail, Calendar, Drive), Penny routing, and signal destinations (Penny, Trail Signals, Notifications, Templates) are live. Remaining Phase 2 work: user-personal preferences — per-user urgency levels, digest vs real-time toggle, personal watch rules with conditional logic, and DB-backed persistence.',
    ...
    acceptanceCriteria: [
      ...
      'User can add, pause, and remove signal sources from personal feed — Phase 2',
      'Urgency levels (High / Medium / Low) configurable per signal type — Phase 2',
      'Digest (daily summary) vs real-time toggle per signal source — Phase 2',
      'Required signals (set by Admin) cannot be disabled by Everyday User — Phase 2',
      'Watch rules support basic conditions (object type, field value, threshold) — Phase 2',
      'Control Center preferences persist across sessions and devices — Phase 2 (needs DB)',
    ],
  },
  {
    id: 'p2-gmail-panel',
