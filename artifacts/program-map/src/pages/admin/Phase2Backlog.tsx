...
const CARDS: BacklogCard[] = [
  ...
  },
  {
    ...
    phase: 'Phase 2',
    owner: 'Tech Lead',
    summary: 'Live at /penny/asset-library (Admin+ tab in Penny hub). Backed by Google Drive — GOOGLE_DRIVE_REFRESH_TOKEN + GOOGLE_DRIVE_PENNY_FOLDER_ID. Six Penny states (coaching, trail-talk, resume-review, interview-prep, confidence-builder, quest-debrief) map to Drive subfolders. Asset cards show thumbnails, mimeType badges, modified date, and open-in-Drive links. ElevenLabs/HeyGen API integrations remain Phase 2.',
    ...
    dependencies: [
      ...
      'GOOGLE_DRIVE_PENNY_FOLDER_ID — admin must create Drive folder + set secret',
