...
const PAGE_AUDITS: PageAudit[] = [
  ...
  { path: '/penny/test',                    name: 'Penny · Ask Penny (hub tab)',     role: 'Admin+', status: 'fixed', issues: 'Sprint 2: standalone /penny/test route removed; TestPenny component now rendered as "Ask Penny" tab in PennyHub at /penny/test; live Gemini LLM wired with rate limiter + multi-turn history. Sprint 3: Ask Penny global slide-over (AskPennyPanel) added — accessible from Topbar on all pages; Penny RAG wired (22-chunk knowledge corpus, keyword scoring, tier filtering, collapsible Sources UI); Penny Reacts to Trail Signals — priority score badges (P1–P10) on every signal card, "Ask Penny about this signal" button auto-populates and auto-sends the panel with full signal context' },
  ...
  { path: '/admin/phase2-backlog',          name: 'Admin · Phase 2 Backlog',         role: 'Admin+', status: 'fixed', issues: 'Sprint 3: three backlog cards moved to Done — Ask Penny Panel (global slide-over), Penny RAG (knowledge corpus + /api/penny/retrieve), Penny Reacts to Trail Signals (priority badges + auto-send signal context to panel)' },
];
...
const HARDCODED_ITEMS: HardcodedItem[] = [
  ...
  { name: 'Penny Insights SIGNAL_ITEMS',     location: 'layout/PagePennyGuide.tsx',          classification: 'phase2-data', p2Item: 'p2-penny-reacts-signals',  notes: 'Signal data still hardcoded (P2 = live sources); Sprint 3: each signal now shows a P1–P10 priority badge + "Ask Penny about this signal" button that auto-fires full signal context into the AskPennyPanel with Gemini RAG response' },
