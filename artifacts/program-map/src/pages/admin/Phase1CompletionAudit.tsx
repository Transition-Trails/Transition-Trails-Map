...
const PAGE_AUDITS: PageAudit[] = [
  ...
  { path: '/operations',                    name: 'Operations · Overview',           role: 'Admin+', status: 'pass',  issues: '' },
  { path: '/operations/health',             name: 'Operations · Health',             role: 'Admin+', status: 'pass',  issues: '' },
  ...
  { path: '/penny/test',                    name: 'Penny · Test Penny',              role: 'Admin+', status: 'pass',  issues: '' },
  ...
  { path: '/knowledge/relationships',       name: 'Knowledge · Relationships',       role: 'Power+', status: 'pass',  issues: '' },
  ...
  { path: '/admin',                         name: 'Admin · Knowledge Hub',           role: 'Admin+', status: 'pass',  issues: '' },
