  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 gap-4 mb-6">
        {[
          { label: 'Active Templates', value: counts.active, dot: 'green' as const },
          { label: 'Draft Templates',  value: counts.draft,  dot: 'amber' as const },
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="bg-card divide-y divide-border">
            {messageTemplates.map(tpl => {
              const sc = STATUS_CONFIG[tpl.status];
              return (
                <tr
                  key={tpl.id}
