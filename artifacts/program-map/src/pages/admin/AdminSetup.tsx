...
const NEEDS_CONFIG: SetupCard[] = [
  {
    ...
    owner: 'Ops Lead',
    detail: 'Replit connector active. Outbound email routing for cohort updates and Penny digests — UI wiring is Phase 2.',
    lastCheck: 'Today',
    action: 'View Secrets',
    href: '/admin/secrets-audit',
    needs: 'Wire first outbound trigger — Penny notification → Gmail send',
  },
  {
    id: 'google-chat',
    name: 'Google Chat',
