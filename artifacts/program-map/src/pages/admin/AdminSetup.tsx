...
const LIVE_INTEGRATIONS: SetupCard[] = [
  ...
  },
  {
    ...
    needs: 'Set GOOGLE_CALENDAR_ID in Replit Secrets to enable per-program calendar queries',
  },
  {
    id: 'agentforce',
    name: 'Agentforce',
...
const PHASE_2: Phase2Item[] = [
  { id: 'mural',      name: 'Mural',           tagline: 'Visual Collaboration',       phase: 'Phase 2', detail: 'Whiteboard integration for sprint planning and retrospectives.' },
  { id: 'lms',        name: 'LMS',             tagline: 'Learning Delivery Platform', phase: 'Phase 2', detail: 'Learning management system for content delivery and assessment.' },
];
...
const READINESS_LINKS: ReadinessLink[] = [
  {
    ...
    detail: 'Full planning workspace — auth status, field mapping, sync readiness, and risk register across all integrations.',
    action: 'Open Center',
  ...
  },
  {
    ...
    detail: 'Trail OS ↔ Salesforce object mappings, product readiness scores by cloud, and field-level validation workflow.',
