...
const MATRIX_ROWS: MatrixRow[] = [
  ...
  { persona: 'Employer Partner',    type: 'Partner',   typeCls: 'text-amber-700 bg-amber-50 border-amber-200',          tier: 'everyday',   tierLabel: 'Everyday', tierOrder: 0, tierDot: 'bg-emerald-500', tierBadge: 'bg-emerald-50 border-emerald-200 text-emerald-700', health: 'incomplete',      healthOrder: 2, navigator: '— Limited',      operations: '— Hidden',       demand: '— Hidden',     penny: '— Planned Q4',   knowledge: '— Hidden',    collaboration: '— Hidden',administration: '— Hidden',  pennyDepth: 'None — employer matching planned Q4',                  sfAccess: 'Account, Opportunity, Job Application, Contact', authMethod: 'Google Sign-In' },
        ...
        <div className="flex items-center justify-between gap-4 px-5 pt-3 pb-0">
          <div className="min-w-0">
            ...
            <p className="text-[12px] text-muted-foreground mt-0.5 mb-3">
              Sort and filter all 11 personas by tier, type, or health. Click a row to inspect its full access profile.
            </p>
          </div>
