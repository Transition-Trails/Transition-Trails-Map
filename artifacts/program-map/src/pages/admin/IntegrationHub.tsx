...
const GOVERNANCE_LINKS: ConfigLink[] = [
  ...
  { id: 'phase1',           name: 'Phase 1 Readiness',           detail: 'Integration scores, capability progress, and blockers across all Phase 1 workstreams.',              href: '/admin/phase1-readiness',      badge: 'Phase 1',       badgeCls: 'bg-amber-50 border-amber-200 text-amber-700',   icon: CheckCircle2 },
  { id: 'phase1-audit',     name: 'Phase 1 Completion Audit',    detail: 'UX compliance review, prototype content inventory, and Penny POC capability assessment.',            href: '/admin/phase1-audit',          badge: 'Audit',         badgeCls: 'bg-violet-50 border-violet-200 text-violet-700', icon: CheckCircle2 },
  { id: 'ux',               name: 'Phase 1 UX Standards',        detail: 'Design rules for navigation, layout, role-aware views, and responsiveness.',                         href: '/admin/ux-standards',          badge: 'Standards',     badgeCls: 'bg-indigo-50 border-indigo-200 text-indigo-700', icon: LayoutIcon   },
