...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'penny-learners',      path: '/penny/learners',     label: 'Learner Pipeline', minTier: 'admin' },
      ...
      { id: 'penny-admin-center',  path: '/penny/admin-center',  label: '⚙ Penny Command Center', minTier: 'admin' },
    ],
  },
  {
    id: 'knowledge',
