...
export const ROUTE_MANIFEST: RouteEntry[] = [
  ...
  { path: '/knowledge/studio/penny-review/:id',  kind: 'active', note: 'Knowledge Studio — Penny\'s Review for specific article' },
  { path: '/knowledge/studio/penny-review',      kind: 'active', note: 'Knowledge Studio — Penny\'s Review tab (article picker)' },
  ...
  { path: '/knowledge/studio/in-app-help',       kind: 'active', note: 'Knowledge Studio — In-app Help tab' },
  { path: '/knowledge/studio/pennys-read',       kind: 'active', note: 'Knowledge Studio — Penny\'s Read tab' },
  { path: '/knowledge/article-studio',           kind: 'redirect', target: '/knowledge/studio' },
