...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "slack-tokens", label: "Slack bot + signing tokens", status: "partial", owner: "Ops Admin", where: "Replit Secrets → SLACK_*", detail: "Bot token, app token, signing secret, 3 channel IDs all configured. @penny posting live. Missing: channels:read + groups:read scopes — add to Slack app manifest.", action: "/admin/integrations", actionLabel: "Fix scopes", tag: "Slack" },
    ],
  },
  {
    id: "google-drive",
