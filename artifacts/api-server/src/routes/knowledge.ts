...
const SEED_SOURCES: KnowledgeSource[] = [
  ...
  },
  {
    ...
    healthStatus: "Warning",
    healthIssues: ["LMS API not yet connected — sync is manual export", "No completion event webhook — Penny cannot auto-trigger on module completion yet"],
    futureIntegrationPath: "Q3 2025 — LMS webhook for completion events. Module content API sync.",
    integrationPriority: "P1",
